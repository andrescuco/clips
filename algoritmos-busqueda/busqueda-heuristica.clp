...
;La función extrae-cop nos da los operadores aplicados para llegar al estado actual
...
;La función estado-simple nos da el estado actual sin los operadores aplicados
...
;Comprueba que no este la aspiradora ni haya suciedad
...
;Nos da el número de habitaciones con suciedad 
...
;Nos da el número de habitaciones no vacias 
...
;Por cada operador aplicado suma el coste 1
...
;Aplica la función dada a cada uno de los estados de la lista
